      ...
      <div className="flex items-center justify-between border-b border-slate-200 pb-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm">Manage customer details and billing info.</p>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredClients.map(client => (
                  <tr key={client._id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-4 font-mono text-slate-600">{client.gstNumber || 'N/A'}</td>
                    <td className="p-4">
        ...
        <div className="max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" name="gstNumber" onChange={handleChange} className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none" placeholder="27AAAAA0000A1Z5" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Email Address</label>
                  <input type="email" name="email" onChange={handleChange} className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none" placeholder="accounts@company.com" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <textarea name="billToAddress" required onChange={handleChange} rows="2" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none" placeholder="Full address for invoicing..."></textarea>
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Shipping Address (Main)</label>
                  <textarea name="address" onChange={handleChange} rows="2" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none" placeholder="Warehouse delivery address..."></textarea>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" name="contactPerson" onChange={handleChange} className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none" placeholder="e.g. Mr. Sharma" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Phone Number</label>
                  <input type="text" name="contactNumber" onChange={handleChange} className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none" placeholder="9876543210" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Payment Terms</label>
                  <select name="paymentTerms" onChange={handleChange} className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none">
            ...
            <div className="flex gap-4">
               ...
               >
                 {loading ? 'Saving...' : <><FiSave /> Save Customer</>}
               </button>
            </div>
